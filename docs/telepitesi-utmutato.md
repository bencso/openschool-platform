...
> 📖 **Dokumentáció:** [Főoldal](../README.md) · [Architektúra](architektura.md) · **Telepítés** · [Fejlesztői környezet](fejlesztoi-kornyezet.md) · [Roadmap](jovokep-es-fejlesztesi-terv.md) · [Felhasználói útmutató](felhasznaloi-utmutato.md) · [Hozzájárulás](../CONTRIBUTING.md)
